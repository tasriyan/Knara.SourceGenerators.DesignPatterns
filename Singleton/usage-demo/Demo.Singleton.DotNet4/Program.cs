...
namespace Demo.Singleton.DotNet4
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("=== Singleton Pattern Generator Demo For .NET 4.8.1 ===");
            Console.WriteLine("==================================");
            SingletonUsageDemo.DemonstrateUsage().GetAwaiter().GetResult();
        }
    }
}
...
public static class SingletonUsageDemo
{
    ...
    public static async Task DemonstrateUsage()
    {
        ...
        var tasks = Enumerable.Range(0, 1000).Select(i => Task.Run(() =>
        {
            ...
            metrics.SetGauge("active_users", _random.NextDouble() * 100);
        }));
